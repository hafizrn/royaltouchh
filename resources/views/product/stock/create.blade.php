...
@section('title', 'Add Product in Stock')
...
@section('breadcrumb')
<h3 class="page-title">Home > Product > Add in Stock</h1>
@endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <h4 class="mt-0 header-title">Stock Entry</h4>
                                @if ($errors->any())
                            ...
                            <form method="post" action="{{ url('product_stock/store') }}">
                                @csrf
